...
class QuestionModule(nn.Module):
    ...
    def forward(self, questions, word_embedding):
        ...
        questions = torch.transpose(questions, 0, 1) # [4, 1, 30]
...
class DMNPlus(nn.Module):
    ...
    def forward(self, context, questions):
        ...
        pred_id= self.answer_module(X, questions)
        return pred_id
